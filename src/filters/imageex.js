...
(function(){    
  ...
  var imageFilterMixinex = {  
    ...
    load : function (point, dataSrc) {       
      var src, tagname = this.getParam('image-tag') || 'fileref', w, h;
  ...
  xtiger.editor.Plugin.prototype.pluginEditors['text'].registerFilter('imageex', imageFilterMixinex);   
